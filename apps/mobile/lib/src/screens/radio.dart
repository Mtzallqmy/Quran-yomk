        ...
        Expanded(
          child: FutureBuilder<List<Station>>(
            ...
            builder: (context, snapshot) {
              ...
              final stations = filter == 'ALL' ? all : all.where((station) => station.source == filter).toList(growable: false);
                    ...
                    return Card(
                      child: ListTile(
                        ...
                        subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                          Text(station.isInternal ? 'بث ترتيل الداخلي' : 'بث خارجي'),
                        ...
                        isThreeLine: station.healthStatus != null || station.attribution != null,
                        trailing: Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
                          ...
                          IconButton(tooltip: 'تشغيل', onPressed: station.isPlayable ? () => services.playback.playStation(station) : null, icon: const Icon(Icons.play_circle_fill)),
                        ]),
                      ),
                    );
                  },
