...
Map<String, dynamic> resolutionJson({String stationId = '11111111-1111-4111-8111-111111111111'}) =>
    <String, dynamic>{
      'available': true,
...
void main() {
  test('virtual resolution preserves logical channel and physical source identities', () {
  ...
  test('virtual API sends bounded failed station IDs to the resolver', () async {
    ...
    final client = MockClient((request) async {
      ...
      return http.Response(
        jsonEncode(<String, dynamic>{'data': resolutionJson(stationId: '22222222-2222-4222-8222-222222222222')}),
        200,
      );
    });
    final api = TarteelApiClient(client: client, baseUrl: 'https://example.test/api/v1');
    await api.virtualRadio(failedStationIds: const <String>[
