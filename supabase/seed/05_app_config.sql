insert into app.app_config (key, value, value_type, is_public, description) values
  ...
  ('support_url', 'null', 'JSON', true, 'Not supplied; remains null'),
  ('privacy_url', 'null', 'JSON', true, 'Not supplied; remains null'),
  ('terms_url', 'null', 'JSON', true, 'Not supplied; remains null'),
